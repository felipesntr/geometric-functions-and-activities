...
update (TimePassing t) ((x, y), (v_x, v_y), angle, rot, accelerating)
  ...
  | x <= (-1) * screenLimitX = ((x + v_x * cos angle + 0.5, y + v_y * sin angle), (v_x, v_y), (-1)*reflectionAngle angle ((-10, 10), (-10, -10)), rot, accelerating)
  | y <= (-1) * screenLimitY = ((x + v_x * cos angle, y + v_y * sin angle + 0.5), (v_x, v_y), reflectionAngle angle ((-9.9, -10), (10, -10)), rot, accelerating)
  | accelerating =
